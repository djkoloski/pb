...
namespace Pb
{
	namespace Collections
	{
			...
			IEnumerable<KeyValuePair<TKey, TValue>>
		{
			...
			private IComparer<TKey> compare_;
			/// <summary>
			...
			private int GetKeyIndex_(TKey key)
			{
				...
				return keys_.BinarySearch(key, compare_);
			}
			...
			/// <summary>
			/// Constructs the map with the default comparer and no key-value pairs
			/// </summary>
			public Map()
			{
				compare_ = Comparer<TKey>.Default;
				keys_ = new List<TKey>();
				values_ = new List<TValue>();
			}
			/// <summary>
			/// Constructs the map with the given comparer and no key-value pairs
			/// </summary>
			/// <param name="compare">The comparer to use</param>
			public Map(IComparer<TKey> compare)
			{
				compare_ = compare;
				keys_ = new List<TKey>();
				values_ = new List<TValue>();
			...
			/// <summary>
			/// Constructs the map with a copy of the key-value pairs in the given map and the default comparer
			/// </summary>
			...
			/// <summary>
			/// Constructs the map with a copy of the key-value pairs in the given map and uses the given comparer
			/// </summary>
			/// <param name="other">The map to copy the key-value pairs of</param>
			/// <param name="compare">The comparer to use</param>
			public Map(Map<TKey, TValue> other, IComparer<TKey> compare)
			{
				compare_ = compare;
				keys_ = new List<TKey>(other.keys_);
				values_ = new List<TValue>(other.values_);
